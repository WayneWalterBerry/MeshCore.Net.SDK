...
/// <summary>
/// Demonstration of MeshCore.Net.SDK with transport selection support and proper logging
/// </summary>
public class MeshCoreDemo
{
    public static async Task RunAsync(DeviceConnectionType? preferredTransport = null, ILoggerFactory? loggerFactory = null)
    {
        var logger = loggerFactory?.CreateLogger<MeshCoreDemo>() ?? Microsoft.Extensions.Logging.Abstractions.NullLogger<MeshCoreDemo>.Instance;
